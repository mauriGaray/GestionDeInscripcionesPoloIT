  ...
  return (
    <div className="login-container w-80 h-auto p-8 lg:ml-20 rounded-lg text-center">
      ...
      <form
        ...
        <button
          type="submit"
          className="login-btn p-2 m-4 bg-green-600 text-white text-xs rounded cursor-pointer">
          ACCEDER
        </button>
      </form>
      ...
      <div className="flex justify-center mt-6 text-xs text-white">
        ...
        <button
          ...
          className="register-btn p-0 ml-2 bg-transparent text-xs text-indigo-400 cursor-pointer border-none font-bold">
          Registrate
        </button>
      </div>
    </div>
