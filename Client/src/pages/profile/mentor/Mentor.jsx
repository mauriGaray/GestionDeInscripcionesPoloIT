        ...
        <div className="grid grid-cols-4 gap-4 min-h-screen">
          ...
          <div className="col-span-3 bg-sky-950">
            ...
            <div className="h-12 pl-4 flex justify-left items-center">
                <h2 className="text-white text-lg font-semibold">MENTOR DEL PROYECTO</h2>    
            </div>
            <div className="bg-slate-600 p-4 min-h-screen">
                <div className="flex">
                    <p>MENTOR:</p><p>Nombre del Mentor</p>
                </div>
                <div className="flex">
                    <p>EMAIL:</p><p>Email del mentor</p>
                </div>
                <div className="flex">
                    <p>TECNOLOGÍAS:</p><p>Tecnologías</p>
                </div>
                <div className="flex">
                    <p>EMPRESA:</p><p>Nombre de la Empresa</p>
                </div>
            </div>
          </div>
